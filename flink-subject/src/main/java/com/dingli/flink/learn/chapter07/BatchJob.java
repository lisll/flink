package com.dingli.flink.learn.chapter07;
...
public class BatchJob {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSet<Tuple2<String, Double>> airportVertices = env
				.readCsvFile("F:\\Flink_learn\\src_data\\data\\nodes.csv").types(String.class, Double.class);

		DataSet<Tuple3<String, String, Double>> airportEdges = env
				.readCsvFile("F:\\Flink_learn\\src_data\\data\\edges.csv")
	...
	final static class SSSPComputeFunction extends ComputeFunction<String, Double, Double, Double> {
		...
		private static final long serialVersionUID = 811557853743249123L;
